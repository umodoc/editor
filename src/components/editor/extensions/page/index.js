import { mergeAttributes,findChildrenInRange,findParentNode, Node} from "@tiptap/core";
import {
  PAGE,
  EXTEND,
  BULLETLIST,
...
import { buildComputedHtml, getFlag, removeComputedHtml } from './core'
import { idPlugin, pagePlugin } from './pagePlugn'
...
export function getSplittedAttributes(extensionAttributes, typeName, attributes) {
